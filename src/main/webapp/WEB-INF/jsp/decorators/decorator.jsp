    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider my-0">
        ...
        <li class="nav-item active">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseboard" aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-fw fa-folder"></i>
                <span class="confirmMenu">게시판</span>
            </a>
            <div id="collapseboard" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">게시판</h6><!--작은이름 -->
                    <a id="ME009" class="collapse-item board" href="#">게시판 보기</a><!--http://localhost:8282/Account33/+html 하이퍼링크 -->
                    <a id="ME009_1" class="collapse-item writeboard" href="#">게시글 쓰기</a>
                </div>
            </div>
        </li>
        ...
        <div id="test" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a id="ME006_3" class="collapse-item ManageBudget" href="#">예산실적현황</a>
              <a id="ME006_4" class="collapse-item ComparisonBudget" href="#">예실대비현황</a>
          </div>
        </div>
      </li>
                    ...
                    <a id="ME006_1" class="dropdown-item ApplyBudget" href="#">예산신청</a> 
                     <a id="ME006_2" class="dropdown-item PlanBudget" href="#">예산편성</a>
                      <a id="ME006_3" class="dropdown-item ManageBudget" href="#">예산실적현황</a>
                        <a id="ME006_4" class="dropdown-item ComparisonBudget" href="#">예실대비현황</a>
                   </div> 
                </li>
  ...
  function starUrlAddress(arrayUrl){
     ...
     arrayUrl.map(function(obj){
        ...
        if(menuCode =="ME001" && level=="0"){
           ...
           $(".ApplyBudget, .PlanBudget, .ManageBudget, .ComparisonBudget").click(function(){
              alertFunc();
              event.preventDefault();
           ...
           $(".authorityGroup, .menuAuthority").click(function(){
            ...
            $(".writeboard, .board").click(function(){
                alertFunc();
                event.preventDefault();
